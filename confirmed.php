...
<!-- Menu -->              
<?php $nav_active = "confirmed"; require ('includes/menus.php'); ?>                      
    ...
    <div class="mt-3 w-100 p-3">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="pt-2 text-dark">Confirmed Leads</h3>
        </div>
        <table class="table card-body">
          ...
          <tbody>
            <tr>
              ...
              <td><a href="http://" class="btn btn-light btn-sm"><img class="pb-1" src="https://img.icons8.com/ultraviolet/15/000000/settings.png">
                  Manage</a> </td>
            </tr>
            <tr>
              <td>20-02-2019</td>
